...
12. For screenshotable visual artifacts, render every final page/slide/state practical to inspect; do not rely on a single sampled screenshot or bounds-only check.
13. Write findings as P0/P1/P2/P3.
14. Fix all P0/P1 and easy P2 issues, including any mismatch with the Request Anchor.
15. Run one more critique pass on the changed artifact.
...
6. Necessary judgment: remove or demote unnecessary elements, tighten inevitable relationships, name craft tolerances, add care states, preserve material honesty, and match scene fit.
7. Accessibility: contrast, focus, semantics, keyboard, reduced motion.
8. Layout: alignment, grouping, spacing rhythm, responsive behavior.
9. Typography: scale, weight, line length, wrapping, overflow, type role, mixed-script fit, fallback, and licensing when relevant.
10. Color: roles, contrast, state parity, palette coherence, visual personality.
11. Interaction: states, feedback, recovery, loading/empty/error.
12. Taste: dial fit, category-default avoidance, layout-family variety, type personality, visual memory, and asset credibility.
13. Craft: motion, imagery, details, anti-slop cleanup.
...
- Necessary judgment failures around care, material honesty, or scene fit are fixed or explicitly accepted as lower-severity risks.
